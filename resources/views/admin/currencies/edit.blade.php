                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter currency name" value="{{ old('name', $currency->name) }}" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" placeholder="Enter currency code (e.g. USD)" value="{{ old('code', $currency->code) }}" required maxlength="3">
                                    @error('code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('symbol') is-invalid @enderror" id="symbol" name="symbol" placeholder="Enter currency symbol" value="{{ old('symbol', $currency->symbol) }}" required maxlength="10">
                                    @error('symbol')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00001" class="form-control @error('conversion_rate') is-invalid @enderror" id="conversion_rate" name="conversion_rate" placeholder="Enter conversion rate to BDT" value="{{ old('conversion_rate', $currency->conversion_rate) }}" required>
