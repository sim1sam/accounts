                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="delivery_class" id="delivery_class" class="form-control @error('delivery_class') is-invalid @enderror">
                                ...
                                <option value="Inside Dhaka" {{ old('delivery_class') == 'Inside Dhaka' ? 'selected' : '' }}>Inside Dhaka</option>
                                <option value="Outside Dhaka" {{ old('delivery_class') == 'Outside Dhaka' ? 'selected' : '' }}>Outside Dhaka</option>
                            </select>
